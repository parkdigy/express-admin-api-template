...
router.get('/user_menu/group', ApiSuperAdminChecker, ApiController(AdminUserMenu.listForGroupEdit));

/********************************************************************************************************************
 * 어드민 사용자 접근 로그
 * ******************************************************************************************************************/
// 어드민 사용자 접근 로그 - 목록
router.get('/user_access_log', ApiControllerReadRole(menu.admin.accessStat, AdminUserAccessLog.list));
// 어드민 사용자 접근 로그 - 등록
 ...
 * ******************************************************************************************************************/
// 어드민 그룹 - 목록
router.get('/group', ApiControllerReadRole(menu.admin.group, AdminGroup.list));
// 어드민 그룹 - 등록
 ...
 * ******************************************************************************************************************/
// 어드민 사용자 - 목록
router.get('/user', ApiSuperAdminChecker, ApiController(AdminUser.list));
// 어드민 사용자 - 등록
router.post('/user', ApiSuperAdminChecker, ApiController(AdminUser.add, true));
// 어드민 사용자 - 정보
router.get('/user/:id', ApiSuperAdminChecker, ApiController(AdminUser.info));
// 어드민 사용자 - 정보 수정
router.patch('/user/:id', ApiSuperAdminChecker, ApiController(AdminUser.edit, true));
// 어드민 사용자 - 비밀번호 초기화
router.patch('/user/:id/password_reset', ApiSuperAdminChecker, ApiController(AdminUser.passwordReset, true));
// 어드민 사용자 - 사용 제한
router.patch('/user/:id/lock', ApiSuperAdminChecker, ApiController(AdminUser.lock, true));
// 어드민 사용자 - 사용 제한 해제
router.patch('/user/:id/unlock', ApiSuperAdminChecker, ApiController(AdminUser.unlock, true));
